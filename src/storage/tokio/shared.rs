//! Tokio async storage implementation shared across all platforms.
//!
//! Each async method offloads to the platform `SyncStorage` via
//! `spawn_blocking`, keeping the async executor free of blocking I/O.
