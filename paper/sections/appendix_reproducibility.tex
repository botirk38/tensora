...
Two regime findings transfer. First, \textbf{async outperforms sync on ServerlessLLM} for both models: by 1.28$\times$ on Mistral-7B (17\,886~ms vs 22\,832~ms). The structural claim that partitioned layouts favour non-sync backends holds across checkpoint families. Second, Qwen3-8B SafeTensors confirms the main-matrix finding: async (5\,412~ms) outperforms sync (6\,064~ms) by 1.12$\times$.
